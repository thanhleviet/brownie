...
void TCODE::EncodeTree (int ni, int nj)
{
	...
	j = nj;
        ...
        //cout<<"jnode is "<<jnode<<endl;
        //if(jnode!=NULL) {
        //    if (jnode->IsLeaf()) {
        //        cout<<"jnode label is ";
        //        cout<<jnode->GetLabel()<<endl;
        //    }
        //    else {
        //        cout<<"!!!!!!!!!!!!!jnode is not a leaf!!!!!!!!!!!!!!!!!!"<<endl;
        //    }
       // }
       // else {
        //    cout<<"///////////////jnode is NULL///////////////////////"<<endl;
        //}
    // Mark path to root
 	NNodePtr q = jnode;
    while (q != NULL)
	...
	//	cout<<"nj is "<<nj<<endl;
        //cout<<"q is "<<q<<" "<<endl;
        //cout<<q->GetLabel()<<endl;
	//	cout<<"q's ancestor is "<<q->GetAnc()<<endl;
        q->SetMarked (true);
        q = (NNode *)(q->GetAnc());
    }
...
void CompareTriplets (NTree &t1, NTree &t2, QTValues &QR)
{
    ...
    for (int j = 1; j <= t1.GetNumLeaves (); j++)
    {
        ...
        TCODE E1 (&t1);
        TCODE E2 (&t2);
       // cout<<"\nStarting to encode t1\n";
        E1.EncodeTree (1, j);
		//cout<<"Now writing\n";
		//E1.Write(cout);
        //cout<<"\nStarting to encode t2\n";
        E2.EncodeTree (1, j);
		//cout<<"Now writing\n";
		//E2.Write(cout);
        //cout<<"\nStarting radix sort\n";
